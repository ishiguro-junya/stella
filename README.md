...
<p align="center">
  人よりAIがコードを書く時代のシンプルなGitクライアント — Gitクライアントをほぼレビューでしか使わない人向け
</p>
...
ファイル、ハンク、行の単位で差分を閲覧・編集することができます。

![変更の画面](docs/assets/changes.png)

### 履歴

コミット、ブランチ、タグを閲覧・検索することができます。
...
言語や外観、差分、ステージの表示などの動作を好みに合わせて設定できます。
